...
<strong>Title: </strong><x-text-input type="text" name="titel" field="titel" placeholder="Title..." class="w-full border-black" autocomplete="off" :value="$artikel->titel"></x-text-input>  <br> <br>
    @error('title')
    <p class="text-red-500 -mt-6">{{ $message }}</p>
    @enderror

    <strong>Description: </strong><textarea type="text" name="inhoud" field="inhoud" placeholder="Description..." class="w-full min-h-44 max-h-80 rounded-md border-black" autocomplete="off">{{ $artikel->inhoud }}</textarea>  <br> <br>
