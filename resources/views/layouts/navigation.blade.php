            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('welcome') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" height="64" width="64" viewBox="0 0 640 512" style="margin-top: center;">
...
{{--                    </x-nav-link>--}}
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button class="inline-flex mt-0.5 -ml-1 items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                                    <div class="hidden space-x-8 sm:-my-px sm:flex">{{ 'Components' }}</div>
...
<br>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">@auth <!-- Controleren of de gebruiker is ingelogd -->
                    <div>{{ Auth::user()->name }}</div>
                    @endauth</div>
                <div class="font-medium text-sm text-gray-500">@auth <!-- Controleren of de gebruiker is ingelogd -->
                    <div>{{ Auth::user()->name }}</div>
                    @endauth</div>
            </div>
